      ...
      <Modalize
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={[styles.buttonTextStyle, {color: Color.Black}]}>
              오늘로 설정
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          onPress={() => {
            ...
            if (!isConnecting) {
              ...
              if (title.trim().length === 0) {
                ...
                add_bucket(userId, title, startDate, bucket_response);
                navigation.goBack();
              }
            }
          }}>
          <Text style={[styles.buttonTextStyle, {fontSize: 15}]}>작성</Text>
        </TouchableOpacity>
      </View>
